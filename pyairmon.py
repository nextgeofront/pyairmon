...
if os_type == 'darwin':
    ...
    handler = TimedRotatingFileHandler('C:\\Users\\fureun05\\pyairmon\\logs\\log.txt', when='midnight')
...
class AirconIrController():
    ...
    def __init__(self):
        ...
        self.scheducler.add_job(self.send_ir_on, 'cron', day_of_week='mon-fri', hour=6, minute=0)
