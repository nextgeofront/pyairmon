...
class AirconIrController():
    ...
    def start(self):
        ...
        if os_type == 'darwin':
            ...
            com_ports = [ p for p in list_ports.comports() if 'USB-SERIAL' in p.device ]
            com_ports.sort(key=lambda x: x.device, reverse=False)
    ...
    def send_ir_command(self, cmd='ON'):
        ...
        if cmd == 'ON':
            cmd_data = [
                    0x32,0x36,0x20,0x30,0x32,0x34,0x34,0x20,0x34,0x35,0x39,0x43,0x20,0x30,0x42,0x41
                    ,0x41,0x20,0x32,0x32,0x46,0x45,0x20,0x30,0x31,0x46,0x36,0x20,0x30,0x31,0x46,0x34
                    ,0x20,0x30,0x31,0x46,0x32,0x20,0x30,0x35,0x44,0x32,0x20,0x30,0x31,0x46,0x36,0x20
            ...
            cmd_data = [
                    0x32,0x36,0x20,0x30,0x32,0x34,0x34,0x20,0x34,0x35,0x42,0x43,0x20,0x30,0x42,0x41
                    ,0x41,0x20,0x32,0x32,0x46,0x41,0x20,0x30,0x31,0x46,0x36,0x20,0x30,0x31,0x46,0x34
                    ,0x20,0x30,0x31,0x46,0x32,0x20,0x30,0x35,0x44,0x32,0x20,0x30,0x31,0x45,0x43,0x20
                    ,0x30,0x42,0x42,0x38,0x20,0x30,0x31,0x20,0x32,0x33,0x20,0x46,0x32,0x20,0x37,0x33
